...
`entities.battery` accepts a single battery object (legacy) or an array of up to 3 battery objects. Each battery is shown as its own circle with SoC and energy in/out. Charge and discharge values are summed for solar/grid/home flow distribution.

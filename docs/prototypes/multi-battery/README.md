...
| --- | --- | --- |
| **A** | Multi-circle bottom row; each pack has SoC + in/out; flows use aggregate totals | Shipped (Approach B) |
...
| **D** | Primary battery in graph + dashed satellite packs (`role: primary \| satellite`) | Not shipped |
